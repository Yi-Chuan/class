...
Select category.name,products.name,products.input_date from Category,products
 where category.id=products.caregoryid
二、写SQL语句，要求统计点击数前十位的：产品名称和产品点击数量。(10分)
Select products.name,product_hit.hit_ip from products,product_hit
 where products.id=product_hit.product_id order by hit_ip desc limit 0,10;
